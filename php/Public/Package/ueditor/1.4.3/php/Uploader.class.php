...
class Uploader
{
    ...
    private function upFile()
    {
        ...
        if (!(move_uploaded_file($file["tmp_name"], $this->filePath) && file_exists($this->filePath))) { //移动失败
        	...
        	require __ROOT__.'/ThinkPHP/Library/Vendor/OSS/autoload.php';
        	//读取配置
        	require __ROOT__.'/Application/Common/Common/function.php';
        	$config = include(__ROOT__.'/Application/Common/Conf/config.php');
        	...
        	try {
        		...
        		try{
        			$object = 'file/'.date('Y-m-d').'/'.$this->oriName;//想要保存文件的名称
        			$file = $this->filePath;			//文件位置
