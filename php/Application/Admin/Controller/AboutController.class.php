...
class AboutController extends AdminController {
	...
	public function edit($id = 0){
		...
		//页面数据
		$info 			= M('About')->field(true)->find($id);
		if(false === $info){
			$this->error('获取配置信息错误');
		}
		$this->assign('info', $info);
	...
	protected function CustomerForm($index=0){
		$FormData[0] = array(
		array('fieldName'=>'单图上传','fieldValue'=>'pic','fieldType'=>'image','isMust'=>1,'fieldData'=>array(),'attrExtend'=>'data-table="demo" data-field="image" data-size=""'),
		array('fieldName'=>'名称','fieldValue'=>'name','fieldType'=>'text','isMust'=>0,'fieldData'=>array(),'attrExtend'=>'placeholder="请输入名称"'),	
		array('fieldName'=>'内容','fieldValue'=>'content','fieldType'=>'text','isMust'=>0,'fieldData'=>array(),'attrExtend'=>'placeholder="请输入内容"'),	
		array('fieldName'=>'隐藏域','fieldValue'=>array('id'),'fieldType'=>'hidden','isMust'=>0,'fieldData'=>array(),'attrExtend'=>'placeholder=""'),
		);
		$FormData[1] = array(
		array('fieldName'=>'单图上传','fieldValue'=>'pic','fieldType'=>'image','isMust'=>1,'fieldData'=>array(),'attrExtend'=>'data-table="demo" data-field="image" data-size=""'),
		array('fieldName'=>'名称','fieldValue'=>'name','fieldType'=>'text','isMust'=>0,'fieldData'=>array(),'attrExtend'=>'placeholder="请输入名称"'),	
		array('fieldName'=>'内容','fieldValue'=>'content','fieldType'=>'textarea','isMust'=>0,'fieldData'=>array(),'attrExtend'=>'placeholder="请输入内容"'),
		array('fieldName'=>'隐藏域','fieldValue'=>array('id'),'fieldType'=>'hidden','isMust'=>0,'fieldData'=>array(),'attrExtend'=>'placeholder=""'),
		);
