...
// 系统控制器
class PublicAccountController extends AdminController {
    /**
     * [setting 系统设置]
...
//                dump($FeedbaceMail);die;
    ...
    public function collectionWeixinNewsMaterial(){
        ...
        $param['offset']    =   $offset;
        $param['count']     =   $limit;
        $news_arr   =   R('Api/Weixin/GetWxNewsMaterial',$param);
...
//            $agentId=8;
        ...
        $param['offset']    =   $offset;
        $param['count']     =   $limit;
        $news_arr   =   R('Api/Weixin/GetWxImageMaterial',$param);
//        dump($news_arr['content']);die;
        $news_list  =   array();
        $news_list  =   $news_arr['content'];
        $news_list  =   array_reverse($news_list);
...
//                dump($material_image_data);die;
    ...
    public function publishMenu(){
        $news_arr   =   R('Api/Weixin/createMenu');
