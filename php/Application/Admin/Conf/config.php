...
return array(
    /* 数据缓存设置 */
    'DATA_CACHE_PREFIX'    => 'xrncms_', // 缓存前缀
    ...
    'ADMIN_IS_VERIFY'=>0,//是否需要验证码登录 0不需要,1需要
    /*验证方式*/
    'VALIDATE_TYPE'=>array(
    	'regex'=>'正则验证',
    	'function'=>'函数验证',
    ...
    /* SESSION 和 COOKIE 配置 */
    'SESSION_PREFIX' => 'xrncms_admin', //session前缀
    'COOKIE_PREFIX'  => 'xrncms_admin_', // Cookie前缀 避免冲突
    ...
    'MENU_POSTTYPE'			=>	array(1=>'列表',2=>'添加',3=>'编辑',4=>'删除',5=>'状态'),
);